...
export function ProductDetailsClient({ product, productImages }: ProductDetailsClientProps) {
    ...
    <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-auto space-y-6">
            <div>
                <h3 className="font-semibold text-lg flex items-center gap-2 mb-2"><Heart className="h-5 w-5 text-accent"/> Package Contents</h3>
            ...
            <QuantitySelector
                ...
                disabled={!inStock}
            />
            <Button size="lg" onClick={handleBuyNow} disabled={!inStock} className="w-full bg-accent text-accent-foreground hover:bg-accent/90">
